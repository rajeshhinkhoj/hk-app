...
public class AppSetupFragment extends Fragment {
   ...
   public static final String TAG = AppSetupFragment.class
            .getSimpleName();

   public static AppSetupFragment newInstance() {
   ...
   public class MyPagerAdapter extends FragmentPagerAdapter {
      ...
      private final String[] TITLES =  getResources().getStringArray(R.array.setup_array);
      ...
      public Fragment getItem(int position) {
         switch (position) {
         case 0:
               return ConfigureFragment.newInstance(new Object[]{position,tabPosition});
         case 1:
             return SettingsFragment.newInstance(new Object[]{position,tabPosition});
